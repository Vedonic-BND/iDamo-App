...
import com.android.vedonic.idamo.CommentsActivity
import androidx.core.content.ContextCompat.startActivity
import com.android.vedonic.idamo.EditCommentActivity
import com.android.vedonic.idamo.EditPostActivity
...
//            saveButton = itemView.findViewById(R.id.post_save_comment_btn)
    ...
    private fun publisherInfo(profileImage: CircleImageView, userName: TextView, publisher: TextView, publisherID: String) {
        ...
        userRef.addSnapshotListener { snapshot, exception ->
            ...
            val options: RequestOptions = RequestOptions()
                .placeholder(com.android.vedonic.idamo.R.drawable.profile)
                .error(com.android.vedonic.idamo.R.drawable.profile)
