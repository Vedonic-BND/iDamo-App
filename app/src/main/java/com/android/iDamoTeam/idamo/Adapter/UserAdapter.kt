...
class UserAdapter (private var mContext: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserAdapter.ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(com.android.iDamoTeam.idamo.R.layout.user_item_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: UserAdapter.ViewHolder, position: Int) {
        ...
        if(holder.userImage == null) {
            // Load default image
            holder.userImage.setImageResource(com.android.iDamoTeam.idamo.R.drawable.profile)
        }else{
    ...
    class ViewHolder (@NonNull itemView: View) : RecyclerView.ViewHolder(itemView){
        var userName: TextView = itemView.findViewById(com.android.iDamoTeam.idamo.R.id.user_name)
        var userImage: CircleImageView = itemView.findViewById(com.android.iDamoTeam.idamo.R.id.user_picture)
